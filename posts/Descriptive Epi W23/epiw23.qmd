...
categories: [public health, visualization, epidemiology, Oregon, Mexico]
---
...
## Oregon’s Health at a National Scale

### Navigating the US Census
...
![Figure 2.a.](Figure_2_a Large.jpeg)
...
The data collected from BRFSS would be useful to me as I pursue a public health career because using these tools I would be able to assist with the implementation of disease prevention and health promotion activities, and the monitoring of trends.

State health departments use in-house interviewers or contract with telephone call centers or universities to conduct the BRFSS surveys throughout the year. The states use a standardized core questionnaire, optional modules, and questions specific to their state. The survey is conducted on both landlines and cell phones using Random Digit Dialing (RDD) techniques.
...
![Figure 3_D_iii_1](Figure_3_D_iii_1 Large.jpeg)
...
![Figure 4.D.iii](Figure_4D_iii Large.jpeg)
...
![Figure 5.B.iv.1 in conjunction with Figure 5.B.iv.2](Figure_5B_iv_1 Large.jpeg)
...
## Mexico and the Global Health Landscape
